...
# Try to force stdout/stderr to UTF-8 so prints with emoji don't crash.
try:
    if hasattr(sys.stdout, "reconfigure"):
        ...
        # Fallback for older Python: replace sys.stdout with a UTF-8 wrapper
        sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding="utf-8", errors="replace")
    sys.stderr = io.TextIOWrapper(sys.stderr.buffer, encoding="utf-8", errors="replace")
except Exception:
    # If reconfiguration fails, continue — we'll fall back to safe printing below
    pass
